...
<body>
	...
	<div  style="margin-left: 10px;">
		<p class="contentText">
		<form id="cadastro" name="cadastro" method="post" action="ConcluirCadastro" onsubmit="return validaCampo(); return false;">
		  <table width="625" border="0">
		    ...
		    <tr>
		      ...
		      <td><input name="cartaoCredito" type="text" id="cpf" maxlength="11"/>
                           <span class="obrigatorio">Apenas números</span>
		      </td>
		    </tr>
                    <tr>
		      <td>Telefone:</td>
		      <td><input name="telefone" type="text" id="telefone" maxlength="8"/>
                           <span class="obrigatorio">Apenas números</span>
		      </td>
		    </tr>
		    <tr>
		      ...
		      <td colspan="2"><p>
		        <input name="cadastrar" type="submit" id="cadastrar" value="Concluir meu Cadastro!" /> 
		          ...
		          <span class="obrigatorio">* Campos com * são obrigatórios!          </span>
                          <a href="jaCadastrado.jsp"> Já sou cadastrado!</a>
                          </p>
		      </td>
		    </tr>
		  </table>
