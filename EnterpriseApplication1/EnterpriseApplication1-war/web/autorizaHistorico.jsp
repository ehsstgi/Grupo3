...
<body>
	...
	<div class="nav1">	
		<ul id="menu">
			...
			<li><a href="cadastro.jsp" title="">Cadastro</a></li>
                        <li><a href="autorizaHistorico.jsp" title="" class="current">Historico de Compras</a></li>
	...
	<div  style="margin-left: 10px;">
		<p class="contentText">
                    Para recuperar seu histórico de compras, preencha seu rg.
		<form id="cadastro" name="cadastro" method="post" action="RecuperarHistorico">
