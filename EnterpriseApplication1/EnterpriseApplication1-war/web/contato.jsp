...
<title>Contato - Nome da Empresa Transportes</title>
...
<body>
	...
	<div class="nav1">	
		<ul id="menu">
			...
			<li><a href="contato.jsp" title="" class="current">Contato</a></li>
		</ul>
	</div>
	...
	<div style="margin-left: 10px;">
		<p class="contentText">
			Entre em contato conosco através de nossas <a href="agencias.jsp">agências</a>.<br /><br />
			
			<img src="images/onibus xavante.jpg" style="margin-left:45px; "alt="Xavante" width="300" height="150" title="xavante" align="bottom" />
		</p>
