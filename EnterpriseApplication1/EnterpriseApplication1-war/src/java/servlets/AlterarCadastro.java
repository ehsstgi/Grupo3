...
public class AlterarCadastro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AlterarCadastro at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
        } finally {            
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        long rgAntigo = Long.parseLong(request.getParameter("rgAntigo"));
        ...
        try {
            ...
            sucesso = bean.alterarCliente(cliente, rgAntigo);
        ...
        if(sucesso){
            out.print("<h3>Usuário alterado com sucesso!</h3><br/>"
